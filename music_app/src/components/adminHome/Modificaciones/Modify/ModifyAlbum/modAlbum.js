...
const ModAlbum = ({ handleSubmit, submitting, reqSuccess, reqMsg, modSuccess, artists, albums }) => {
        ...
        <div className = "wrapper">
            <div className = "form-wrapper">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <Field name="newalbumname" className="firstName" label="Nombre de Album" component={renderInput}/>
                    <Field name="newartistid" className="firsname" label="Artista" component={renderSelect}>
                        {
                    ...
                    <div className="createAccount">
                        <button type="submit" disabled={submitting}>Modificar Album</button>
                    </div>
                </form>
                {
...
export default reduxForm({
    ...
    onSubmit(values, dispatch){
        const requestInfo = { uri: `http://localhost:8000/album/update`, type: 'PUT' };
