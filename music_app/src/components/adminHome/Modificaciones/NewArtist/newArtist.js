...
const NewArtist = ({ handleSubmit, submitting, reqSuccess, reqMsg, modSuccess }) => {
        ...
        <div className = "wrapper">
            <div className = "form-wrapper">
                ...
                <form onSubmit={handleSubmit}>
                    <Field name="artistname" className="firstName" label="Nombre de Artista" component={renderInput}/>
                    {
                        reqSuccess ? <div  className="alert" ><Alert color="danger">Ups! {reqMsg.msg}</Alert></div> : null
                    }
                    <div className="createAccount">
                        <button type="submit" disabled={submitting}>Agregar Artista</button>
                    </div>
                </form>
                {
...
export default reduxForm({
    ...
    onSubmit(values, dispatch){
        ...
        const requestInfo = { uri: `http://localhost:8000/new-artist`, type: 'POST' };
